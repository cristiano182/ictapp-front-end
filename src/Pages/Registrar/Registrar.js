  ...
  responseFacebook = async res => {
    ...
    if (!this.state.curso) {
      ...
      try {
        ...
        if (this.state.curso === "INTERDISCIPLINAR CIÊNCIA E TECNOLOGIA") {
          curso = "required_BCT";
          cargaHoraria = 468;
          cursoName =  "Interdisciplinar Ciência e Tecnologia";
          cargaHorariaComplementar = 420;
        }
        if (this.state.curso === "BACHARELADO BIOTECNOLOGIA") {
          curso = "required_BBT";
          cursoName =  "Bacharelado Biotecnologia";
          cargaHoraria = 2196;
          cargaHorariaComplementar = 108;
        }
        if (this.state.curso === "BACHARELADO CIÊNCIA DA COMPUTAÇÃO") {
          curso = "required_BCC";
          cursoName =  "Bacharelado Ciência da Computação";
          cargaHoraria = 2196;
          cargaHorariaComplementar = 144;
        }
        if (this.state.curso === "BACHARELADO MATEMATICA COMPUTACIONAL") {
          curso = "required_BMC";
        ...
        if (this.state.curso === "ENGENHARIA DA COMPUTAÇÃO") {
          curso = "required_EC";
